...
CSStrMessage.prototype.write = function (buf) {
    buf.writeBooleanField(8, this._success);
...
CSStrMessage.prototype.getSerializedSize = function () {
    ...
    size = 0;
    size += io.computeBooleanFieldSize(1, this._success);
...
CSStrMessage.prototype.toString = function (indent) {
    ...
    str += "\n";
    str += indent + rightPad("_success", filedPad) + " = " + this._success;
    str += "\n";
